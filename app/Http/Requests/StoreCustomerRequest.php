...
class StoreCustomerRequest extends FormRequest
{
    ...
    public function rules()
    {
        return [
            ...
            'cpf' => 'required_without:cnpj|cpf|formato_cpf|unique:customers,cpf|max:14|nullable',
            'cnpj' => 'required_without:cpf|cnpj|formato_cnpj|unique:customers,cpf|max:18|nullable',
